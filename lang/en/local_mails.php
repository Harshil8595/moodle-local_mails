...
$string['pluginname'] = 'Mailbox';
$string['from'] = 'From:';
$string['to'] = 'To:';
$string['cc'] = 'CC:';
$string['bcc'] = 'BCC:';
$string['attachmets'] = 'Attachmets';
$string['viewplain'] = 'View plain';
$string['nomails'] = 'You have no mails';
$string['typesender'] = 'Sentbox';
$string['typereceiver'] = 'Inbox';
$string['typeall'] = 'Other';
